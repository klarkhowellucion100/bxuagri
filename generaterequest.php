                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="main-container fl-wrap fix-container-init">
                                    ...
                                    <div class="list-post-wrap list-post-wrap_column list-post-wrap_column_fw" id="page_pr">
                                        ...
                                        <table style="width: 100%;" >
                                            ...
                                            <tr>
                                                <td colspan=4 style="text-align:left;"><span style="font-size: 13px;"> Code: <?php echo $result1['codef']; ?><br>Number: <?php echo $result1['idf']; ?> </span> </td>
                                                <td colspan=1 style="text-align:right;"><span style="font-size: 13px;"> CAgO-CF Form 7 </span> </td>
                                            </tr>
                                            ...
                                            <tr>                                              
                                                ...
                                                <td colspan=2 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['fnamef']; ?></span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; font-weight:bold;">Date</span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['mfullf']; ?></span></td>
                                            </tr>

                                            <tr>                                              
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; font-weight:bold;">Address</span></td>
                                                <td colspan=2 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['apppurokf']; ?>, <?php echo $result1['brgyf']; ?>, Butuan City, Caraga, Philippines, 8600</span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; font-weight:bold;">Tel/Cellphone No.</span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['cnumberf']; ?></span></td>
                                            </tr>

                                            <tr>                                              
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; font-weight:bold;">Office</span></td>
                                                <td colspan=2 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['appofficef']; ?></span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; font-weight:bold;">Email Address</span></td>
                                                <td colspan=1 style="text-align:center;"><span style="font-size: 15px; text-align:left;"><?php echo $result1['eaddrf']; ?></span></td>
                                            </tr>
                                            ...
                                            <tr>                                              
                                                <td colspan=5 style="text-align:center;"><span style="font-size: 15px;"><?php echo $result1['appdetf']; ?></span></td>                                              
                                            </tr>

                                            <tr>                                              
                                                <td colspan=5 style="text-align:right;"><span style="font-size: 15px; font-weight:bold; padding: 40px;"></span></td>                                              
                                            </tr>

                                            <tr >  
                                                <td colspan=1 style="text-align:right; border:none;"><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Example" alt=""></td>   
                                                <td colspan=2 style="text-align:right; border:none;"><span style="font-size: 10px;">Client's Signature over Printed Name</span></td>                                             
                                                <td colspan=2 style="text-align:right; border:none;"><span style="font-size: 10px;"></span></td>    
                                        ...
                                        <script>
                                            function printDiv() {
                                                var divContents = document.getElementById("page_pr").innerHTML;
                                                var a = window.open('', '', 'height=500, width=500');
                                                a.document.write('<html>');
                                                a.document.write('<body > <style> table, td, th { border: 1px solid #ddd;text-align: left;}table {border-collapse: collapse;width: 100%;}th, td { padding: 15px;}</style>');
                                    ...
                                    <div class="clearfix"></div>
                                    <button class="load-more_btn lmb_center-align" onclick="printDiv()"><i class="fa fa-undo"></i>Print</button>
