                    ...
                    <div class="appointment-form">
                        <div class="bd-section-title-wrapper centered-title appointment-section-title-wrapper">
                            <div class="bd-section-subtitle st-b">
                                CAgO <span>Product Services</span>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="single-input-field field-l-name">
                                        <input type="text" name="spcf" placeholder="Please Select Products" list="specifc">
                                            <datalist id="specifc">                                                
                                                <option value="Seedlings">
                                                <option value="Piglets">
                                                <option value="Palay">
                                                <option value="Rice Certified Seeds">
                                                <option value="Others">
                                            </datalist>
                                    </div>
                                </div>
