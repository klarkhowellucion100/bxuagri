                                  ...
                                  <!--<table class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;"> -->
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php
                                                include 'db.inc.php';
                                                $query1 = mysqli_query($conn,"SELECT * FROM services WHERE docstat='Approve' AND (enpe LIKE '%$useroffice%') ORDER BY tms ASC");
                                              ...
                                              ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="pendingrequestsprintreq.php?print=<?php echo $result1['idf'];?>">Request From</a>
                                                        <a class="dropdown-item" href="pendingrequestsprintcol.php?print=<?php echo $result1['idf'];?>">Collection Slip</a>
                                                    </div>
                                                </td>

                                                <!--<td> <a href="pendingrequestsprint.php?print=<?php echo $result1['idf'];?>" class="btn  btn-raised btn-warning waves-effect">Print</a></td> -->
